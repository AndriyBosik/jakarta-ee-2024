            ...
            <ul class="collection category-list">
                ...
                >
                    <li class="collection-item ${category.id == selectedCategoryId ? 'selected' : ''}">
                        <a href="/menu/${category.id}">${category.title}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
                            ...
                            <div class="food-item">
                                <div class="full-width s-hflex">
                                    ...
                                    <tf:forAdmin>
                                        ...
                                        <div class="clickable food-delete food-action s-vflex-center">
                                ...
                                <div class="food-price s-hflex">
                                    ...
                                    <div class="food-price-value">
                                        <fmt:formatNumber value="${foodItem.price}" type="number" minFractionDigits="2" maxFractionDigits="2" /> UAH
                                    </div>
                                </div>
                                <div class="food-actions full-width s-hflex-start">
                                    <div>
                                        <a href="/food/${foodItem.id}" class="btn btn-small waves-effect waves-light">View</a>
                                    </div>
                                    <div class="equal-flex"></div>
