            ...
            <div class="s-vflex">
                ...
                <div class="s-hflex">
                    <div class="input-field col s12 m9">
                        ...
                        <input id="title" type="text" name="title" value="${food.title}"/>
                    </div>
                    <div class="input-field col s12 m3">
                        <div class="input-field col s12">
                            <select id="category" name="category-id">
                                <c:forEach items="${categories}" var="category">
                                    <option value="${category.id}" ${food.categoryId == category.id ? 'selected' : ''}>${category.title}</option>
                                </c:forEach>
                            </select>
                ...
                <div class="input-field">
                    ...
                    <textarea id="description" name="description" class="materialize-textarea">${food.description}</textarea>
                </div>
                <div class="input-field">
                ...
                <div>
                    <input type="hidden" name="original-image-path" value="${food.imagePath}" />
                </div>
                <div class="file-field input-field">
                    ...
                    <div class="file-path-wrapper">
                        <input class="file-path validate" type="text" name="image-path" value="${food.originalImagePath}" />
                    </div>
                </div>
